...
quadrantChart
    ...
    quadrant-4 Premium shallow
    LBR-Private-Vegan: [0.80, 0.88]
    LBR-Train-Street: [0.68, 0.90]
    LBR-Join-in-6brews: [0.40, 0.85]
    LBR-Vegan-Join-in: [0.40, 0.80]
    Nguyens-Coffee: [0.32, 0.70]
    Hanoi-Coffee-Station: [0.45, 0.55]
    Backstreet-Academy: [0.22, 0.40]
    Heritage-Giang-Loading-T: [0.10, 0.30]
    Budget-walk-in: [0.05, 0.15]
```
